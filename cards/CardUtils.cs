...
namespace LifeCost.cards
{
    public static class CardUtils
    {
		...
		public static AbilityInfo CreateAbilityWithDefaultSettings(
				string rulebookName, string rulebookDescription, Type behavior, Texture2D text_a1, Sprite text_a2,
		...
		)
		{
			...
			createdAbilityInfo.activated = true;
			...
			createdAbilityInfo.pixelIcon = text_a2;
