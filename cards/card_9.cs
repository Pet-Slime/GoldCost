...
namespace LifeCost.cards
{
    public static class card_9
    {
		public static void AddCard()
		{
			...
			customAbilities.Add(AbilityIdentifier.GetID("extraVoid.inscryption.voidSigils", "Prideful"));
			...
			NewCard.Add(name: "lifescrybe_proud",
				displayedName: "? ? ?",
				baseAttack: 4,
				baseHealth: 1,
				metaCategories,
