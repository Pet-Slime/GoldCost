...
namespace LifeCost.cards
{
    public static class card_7
    {
		public static void AddCard()
		{
			...
			customAbilities.Add(AbilityIdentifier.GetID("extraVoid.inscryption.voidSigils", "Firestarter"));
			...
			NewCard.Add(name: "lifescrybe_hotStreak",
				displayedName: "HotStreak",
				baseAttack: 1,
				baseHealth: 5,
				metaCategories,
				cardComplexity: CardComplexity.Advanced,
				temple: CardTemple.Undead,
				description: "The hotstreak",
